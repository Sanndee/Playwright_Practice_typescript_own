...
import datarray from "../testdata/Readdatafromjsonfile.json"
import loginnarray from "../testdata/logindata.json"

test.beforeEach(async ({ page }) => {
    //Login
    await page.goto('https://opensource-demo.orangehrmlive.com/web/index.php/dashboard/index');
    await page.getByPlaceholder('Username').fill(loginnarray.username);
    await page.getByPlaceholder('Password').fill(loginnarray.password);
